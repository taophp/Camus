...
<!-- SECTION:PLAN:BEGIN -->
1. Draft the final proposal in the ticket for quick review.
...
<!-- SECTION:NOTES:BEGIN -->
Archiving: premature and out-of-scope (and IA redacted) ticket. It focuses on terminological details (claim / tests / clues) while the fundamentals of the language (syntax, model, semantics) are not yet defined.
